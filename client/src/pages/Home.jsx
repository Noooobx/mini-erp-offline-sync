  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white flex flex-col">
      ...
      <footer className="border-t border-zinc-900 bg-zinc-950 py-6 mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-6 sm:gap-4 text-center sm:text-left">
          <p className="text-zinc-500 text-sm">
            © {new Date().getFullYear()} Shop Pilot. All rights reserved.
          </p>
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-6 text-sm text-zinc-400">
            <a href="mailto:nandunandakishor345@gmail.com" className="hover:text-zinc-200 transition-colors break-all">
